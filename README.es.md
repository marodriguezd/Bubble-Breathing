...
- **Experiencia de Respiración Personalizada**
    - **Guía Visual:** Una "burbuja de respiración" dinámica sincronizada con tu respiración.
    - **Ayudas Auditivas:** Sonidos opcionales para guiar la inhalación/exhalación sin mirar la pantalla.
    - **Ciclos Personalizados:** Ajusta rondas, respiraciones por ronda y volumen.
    - **Ritmo Flexible:** Velocidades Lenta, Estándar y Rápida con previsualización en vivo.

- **Gestión Inteligente de Sesiones**
    - **Temporizadores Automáticos:** Registra la apnea (retención) y las fases de recuperación automáticamente.
    - **Control Dinámico:** Salta cualquier fase en cualquier momento.
    - **Resumen de Sesión:** Revisa los tiempos de retención y promedios al finalizar.

- **Experiencia de Usuario Premium**
    - **Listo para PWA:** Instálalo en tu pantalla de inicio para una experiencia tipo aplicación sin conexión.
    - **Persistencia:** Tus ajustes se guardan automáticamente.
    - **Soporte Multilingüe:** Disponible en inglés, español, francés, italiano, alemán, portugués y chino simplificado.
    - **Diseño de Borde a Borde:** Layout totalmente responsivo optimizado para móviles.

## 📱 Cómo Instalar

Instala Bubble Breathing como aplicación web (PWA) para la mejor experiencia:

1. **Abre** el enlace en tu navegador (Chrome/Android, Safari/iOS).
2. **Toca** el botón Menú (⋮) o Compartir (⎙).
